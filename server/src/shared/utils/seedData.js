...
// Import Models
const Election = require('../../features/election/election.model');
const Candidate = require('../../features/candidate/candidate.model');
...
const seedData = async () => {
    try {
        ...
        await Voter.deleteMany({ isAdmin: false });
        await Voter.deleteMany({ email: 'admin@egator.com' });
...
✅ ${createdCandidates.length} Candidates created
